...
function getDashboardExportColumns() {
  return [
    ...
    ["reviewCount", "Отзывы"],
    ["hasVideo", "Видео"],
    ["hasRecommendations", "Рекомендации"],
    ["hasRich", "Рич"],
    ["hasAutoplay", "Автоплей"],
    ["hasTags", "Тэги"],
    ["coverDuplicate", "Дубль обложки"],
    ["recommendationCount", "Кол-во рекомендаций"],
    ["listingSlidesCount", "Кол-во слайдов листинга"],
    ["richSlidesCount", "Кол-во блоков рич-контента"],
    ["colorCount", "Кол-во товаров в склейке"],
    ["recommendationRefs", "Артикулы рекомендаций"],
    ["colorNmIds", "Артикулы склейки"],
    ["marketError", "Ошибка market API"],
    ["rowError", "Ошибка строки"],
    ["problemLoadError", "Проблема: ошибка загрузки"],
    ["problemRecommendations", "Проблема: рекомендации"],
    ["problemRich", "Проблема: рич"],
    ["problemVideo", "Проблема: видео"],
    ["problemAutoplay", "Проблема: автоплей"],
    ["problemTags", "Проблема: тэги"],
    ["problemCoverDuplicate", "Проблема: дубль обложки"],
    ["updatedAt", "Обновлено"],
    ["lastSavedAt", "Сохранено"],
    ["savedByLogin", "Сохранил (логин)"],
    ["savedByRole", "Сохранил (роль)"],
    ["savedByIp", "IP сохранения"],
  ];
}
